{{-- Supplier Invoices - Edit Invoice --}}
<x-dashboard.layout title="تعديل الفاتورة" userRole="supplier" :userName="auth()->user()->name" userType="مورد">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        {{-- Form --}}
        <form action="{{ route('supplier.invoices.update', $invoice) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-medical p-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-medical-gray-500">يمكنك رفع ملفات PDF إضافية للفاتورة</p>
                </div>
