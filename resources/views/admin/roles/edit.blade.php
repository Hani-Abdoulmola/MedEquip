{{-- Admin Roles Management - Edit Role (DocuTechHub Style) --}}
<x-dashboard.layout title="تعديل الدور" userRole="admin" :userName="auth()->user()->name" userType="مدير النظام">
            ...
            <ol class="inline-flex items-center space-x-2 space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="mr-2 text-sm font-medium text-medical-gray-700">تعديل البيانات</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    {{-- Page Header --}}
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-medical-gray-900 mb-2">تعديل دور الموظفين</h2>
        <p class="text-medical-gray-600">تحديث معلومات الدور والصلاحيات المخصصة للموظفين (Staff)</p>
    </div>
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="post" id="form">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-6">
            <div class="px-6 py-4 border-b border-medical-gray-200 bg-medical-gray-50">
                <h5 class="text-lg font-semibold text-medical-gray-900">تعديل البيانات</h5>
            </div>
            <div class="p-6">
