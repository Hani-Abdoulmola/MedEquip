{{-- Admin Suppliers Management - Edit Supplier --}}
<x-dashboard.layout title="تعديل مورد" userRole="admin" :userName="auth()->user()->name" userType="مدير النظام">

    {{--
    ADMIN SUPPLIERS EDIT PAGE - Form Page Pattern
    Controller: SupplierController@edit, SupplierController@update
    --}}
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-medical-gray-900 font-display">تعديل مورد</h1>
                <p class="mt-2 text-medical-gray-600">تعديل بيانات المورد: {{ $supplier->company_name }}</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="commercial_register" name="commercial_register"
                            value="{{ old('commercial_register', $supplier->commercial_register) }}" required
                    ...
                    <div>
                        ...
                        <input type="tel" id="contact_phone" name="contact_phone"
                            value="{{ old('contact_phone', $supplier->contact_phone) }}" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="address" name="address" rows="3" required
                            class="w-full px-4 py-3 border border-medical-gray-300 rounded-xl focus:ring-2 focus:ring-medical-blue-500 focus:border-medical-blue-500 transition-all duration-200 @error('address') border-red-500 @enderror">{{ old('address', $supplier->address) }}</textarea>
                        @error('address')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name"
                            value="{{ old('name', $supplier->user->name) }}" required
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-medical-gray-500">اتركه فارغاً إذا كنت لا تريد تغيير كلمة المرور
                        </p>
                        @error('password')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
