{{-- Admin Manufacturer Management - Edit Manufacturer --}}
<x-dashboard.layout title="تعديل الشركة المصنعة" userRole="admin" :userName="auth()->user()->name" userType="مدير النظام">

    <div class="max-w-4xl mx-auto">
        {{-- Page Header --}}
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-medical-gray-900 font-display">تعديل الشركة المصنعة</h1>
                <p class="mt-2 text-medical-gray-600">{{ $manufacturer->name }}</p>
            </div>
        ...
        {{-- Form --}}
        <form action="{{ route('admin.manufacturers.update', $manufacturer) }}" method="POST" class="bg-white rounded-2xl shadow-medical p-8">
            @csrf
            @method('PUT')
                ...
                <div class="border-b border-medical-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_ar" value="{{ old('name_ar', $manufacturer->name_ar) }}"
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $manufacturer->slug) }}"
                ...
                <div class="border-b border-medical-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="category_id"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('category_id', $manufacturer->category_id) == $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="country" value="{{ old('country', $manufacturer->country) }}"
