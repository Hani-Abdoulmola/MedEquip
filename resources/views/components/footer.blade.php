        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-2xl font-bold">MedEquip</span>
                </div>
                <p class="text-gray-300 mb-6 leading-relaxed max-w-md">
                    منصة رائدة في تجارة المعدات والأجهزة الطبية، نربط الموردين بالمؤسسات الطبية في العالم العربي من خلال
                    حلول رقمية مبتكرة وآمنة.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#faq" class="text-gray-300 hover:text-white transition-colors">الأسئلة الشائعة</a>
                    </li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">أجهزة التشخيص</a>
                    </li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">معدات الجراحة</a>
                    </li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">معدات المختبرات</a>
                    </li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">أجهزة المراقبة</a>
                    </li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">معدات التأهيل</a>
                    </li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">معدات الطوارئ</a>
                    </li>
