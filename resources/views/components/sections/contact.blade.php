    ...
    <div class="container">
        ...
        <div class="text-center mb-16 fade-up">
            ...
            <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                ابدأ رحلتك مع
                <span class="text-primary">MedEquip</span>
            </h2>
                    ...
                    <form id="contact-form" class="space-y-6">
                        ...
                        <div>
                            <label for="organization"
                                class="block text-sm font-medium text-gray-700 mb-2">المؤسسة/الشركة</label>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <label for="privacy" class="text-sm text-gray-600">
                                أوافق على <a href="#" class="text-primary hover:underline">سياسة الخصوصية</a> و <a
                                    href="#" class="text-primary hover:underline">شروط الاستخدام</a>
                            </label>
                        </div>
            ...
            <div class="slide-in-left">
                <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="opacity-90">info@medequip.ly</div>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="tel:+218915551234"
                            class="bg-secondary text-white rounded-2xl p-6 text-center hover:bg-secondary-dark transition-colors group">
                            <svg class="w-8 h-8 mx-auto mb-3 group-hover:scale-110 transition-transform"
                        ...
                        <a href="mailto:info@medequip.ly"
                            class="bg-accent text-white rounded-2xl p-6 text-center hover:bg-accent-dark transition-colors group">
                            <svg class="w-8 h-8 mx-auto mb-3 group-hover:scale-110 transition-transform"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
