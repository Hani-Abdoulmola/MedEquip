...
<div
    class="relative bg-gradient-to-br {{ $gradient }} rounded-2xl p-8 shadow-medical-xl overflow-hidden animate-fade-in-up">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-0 -left-20 w-64 h-64 bg-white/10 rounded-full blur-3xl animate-pulse-slow"
    ...
    <div class="relative z-10">
        <div class="flex items-start justify-between mb-6">
            <div>
                {{-- Greeting Badge --}}
                <div
                    class="inline-flex items-center space-x-2 space-x-reverse bg-white/20 backdrop-blur-sm border border-white/30 px-4 py-2 rounded-full mb-4">
