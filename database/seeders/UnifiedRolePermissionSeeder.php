    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            'Staff' => [
                'ar_name' => 'موظف',
                'permissions' => [
                    // Staff role has NO default permissions
                    // Admin must explicitly grant permissions to each Staff user via UI
                    // Permissions are assigned directly to users, not to the role
                ],
            ],
        ];
